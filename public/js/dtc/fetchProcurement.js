...
function fetchProcurementForSaro(saroNo) {
    const url = saroNo === '' ? '/api/dtc/fetch-procurement-dtc' : `/api/dtc/fetch-procurement-dtc?saro_no=${saroNo}`;
...
function fetchProcurementForYear(year) {
    const url = year === '' ? '/api/dtc/fetch-procurement-dtc' : `/api/dtc/fetch-procurement-dtc?year=${year}`;
