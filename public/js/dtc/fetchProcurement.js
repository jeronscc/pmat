...
function fetchProcurementForSaro(saroNo) {
    const url =
        saroNo === ""
            ...
            : `/api/dtc/fetch-procurement-dtc?saro_no=${saroNo}`;
...
function fetchProcurementForYear(year) {
    const url =
        year === ""
            ? "/api/dtc/fetch-procurement-dtc"
            : `/api/dtc/fetch-procurement-dtc?year=${year}`;
...
function openProcurementModal(item) {
    ...
    const url = `/api/dtc/fetch-procurement-details?procurement_id=${procurementId}`;
...
function fetchProcurementData(year = "", status = "all") {
    let url = "/api/dtc/fetch-combined-procurement-data";
