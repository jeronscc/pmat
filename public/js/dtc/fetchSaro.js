        ...
        .then((data) => {
            ...
            if (data.success) {
                data.ntca.forEach((ntca) => {
                    ...
                    ntcaLabelElement.textContent = `NTCA (${ntca.ntca_no} | ${currentQuarter ? currentQuarter : 'No Quarter'})`;                    const currentQuarterBalance = currentQuarter ? ntca[currentQuarter] : 0;
