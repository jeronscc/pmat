document.addEventListener('DOMContentLoaded', function () {
    ...
    const procurementUpdateUrl = "/api/dtc/procurement/update"; // Use the API route for procurement update
    ...
    if (ntcaNoField) {
        ...
        fetch(`/api/dtc/ntca-by-saro?saro_no=${encodeURIComponent(saroNo)}`)
            .then(res => res.json())
            .then(data => {
    ...
    document.getElementById('saveChanges').addEventListener('click', function (e) {
        ...
        fetch(procurementUpdateUrl, {
            ...
            .then(data => {
                ...
                window.location.href = '/homepage-dtc'; // Refresh the page after saving
            })
            .catch(error => {
    ...
    document.getElementById('cancelChanges').addEventListener('click', function (e) {
        e.preventDefault();
        window.location.href = '/homepage-dtc';
    });
    ...
    function checkUploadStatus(procurementId, modalNumber, callback) {
        fetch(`/api/dtc/uploadedProcurementFilesCheck/${procurementId}?modal=${modalNumber}`)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
