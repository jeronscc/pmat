...
function fetchProcurementForSaro(saroNo) {
    const url =
        saroNo === ""
            ...
            : `/api/click/fetch-procurement-click?saro_no=${saroNo}`;
...
function fetchProcurementForYear(year) {
    const url =
        year === ""
            ? "/api/click/fetch-procurement-click"
            : `/api/click/fetch-procurement-click?year=${year}`;
...
function openProcurementModal(item) {
    ...
    const url = `/api/click/fetch-procurement-details?procurement_id=${procurementId}`;
...
function fetchProcurementData(year = "", status = "all") {
    let url = "/api/click/fetch-combined-procurement-data";
