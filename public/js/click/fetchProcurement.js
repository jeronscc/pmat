...
function fetchProcurementForSaro(saroNo) {
    const url = saroNo === '' ? '/api/click/fetch-procurement-click' : `/api/click/fetch-procurement-click?saro_no=${saroNo}`;
...
function fetchProcurementForYear(year) {
    const url = year === '' ? '/api/click/fetch-procurement-click' : `/api/click/fetch-procurement-click?year=${year}`;
