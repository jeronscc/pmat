document.addEventListener("DOMContentLoaded", function () {
    document
        ...
        .addEventListener("click", function () {
            ...
            fetch("/api/click/add-procurement-click", {
                method: "POST",
                headers: {
    ...
    function fetchSaroByYear(year) {
        fetch(`/api/click/fetch-saro-click?year=${year}`)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        ...
        .addEventListener("click", function () {
            ...
            var redirectUrl = "/clickSVP"; // default for SVP
            if (category === "Honoraria") {
                redirectUrl = "/clickHonoraria";
            } else if (category === "Daily travel expense") {
                redirectUrl = "/clickDTE";
            }
