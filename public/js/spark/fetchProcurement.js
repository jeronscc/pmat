...
function fetchProcurementForSaro(saroNo) {
    const url = saroNo === '' ? '/api/spark/fetch-procurement-spark' : `/api/spark/fetch-procurement-spark?saro_no=${saroNo}`;
...
function fetchProcurementForYear(year) {
    const url = year === '' ? '/api/spark/fetch-procurement-spark' : `/api/spark/fetch-procurement-spark?year=${year}`;
