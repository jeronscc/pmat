document.addEventListener('DOMContentLoaded', function () {
    ...
    const procurementUpdateUrl = "/api/spark/honoraria/update"; // Use the API route for procurement update
    ...
    function checkUploadStatus(procurementId, modalNumber, callback) {
        fetch(`/api/spark/uploadedHonorariaFilesCheck/${procurementId}?modal=${modalNumber}`)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
