document.addEventListener("DOMContentLoaded", function () {
    document
        ...
        .addEventListener("click", function () {
            ...
            fetch("/api/spark/add-procurement-spark", {
                method: "POST",
                headers: {
    ...
    function fetchSaroByYear(year) {
        fetch(`/api/spark/fetch-saro-spark?year=${year}`)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        ...
        .addEventListener("click", function () {
            ...
            var redirectUrl = "/sparkSVP"; // default for SVP
            if (category === "Honoraria") {
                redirectUrl = "/sparkHonoraria";
            } else if (category === "Daily travel expense") {
                redirectUrl = "/sparkDTE";
            }
