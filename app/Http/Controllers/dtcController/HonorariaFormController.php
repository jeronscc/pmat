...
class HonorariaFormController extends Controller
{
    public function showForm(Request $request)
    {
        ...
        if (!$record) {
            DB::connection('dtc')->table('honoraria_form')->insert([
    ...
    public function updateHonoraria(Request $request)
    {
        $validatedData = $request->validate([
            'procurement_id' => 'required|exists:dtc.honoraria_form,procurement_id',
        ...
        try {
            ...
            $record = DB::connection('dtc')->table('honoraria_form')
            ...
            DB::connection('dtc')->transaction(function () use ($validatedData, $unit, $status, $record) {
    ...
    public function upload(Request $request)
    {
        try {
            ...
            $uploadedFiles = DB::connection('dtc')
                ->table('requirements')
                ->where('procurement_id', $request->procurement_id)
                ->get();
