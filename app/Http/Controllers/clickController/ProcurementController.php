...
class ProcurementController extends Controller
{
    public function addProcurement(Request $request)
    {
        try {
            ...
            DB::connection('click')->table('procurement')->insert([
            ...
            if ($category === 'svp') {
                ...
                DB::connection('click')->table('procurement_form')->insert([
                    'procurement_id' => $request->input('pr_number'),
                    'activity'       => $request->input('activity'),
                    'saro_no'        => $request->input('saro_number'),
            ...
            DB::connection('click')->table('saro')
    ...
    public function fetchProcurementDetails(Request $request)
    {
        ...
        if ($procurement) {
            ...
            $budgetSpent = DB::connection('click')
    ...
    public function fetchCombinedProcurementData(Request $request)
    {
        try {
            ...
            $procurements = DB::connection('click')->table('procurement')
    ...
    {
        $overdueProcurements = DB::connection('click')->select("
            SELECT 
                procurement_id, 
                activity, 
