...
class ProcurementFormController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validatedData = $request->validate([
            'procurement_id' => 'required|exists:spark.procurement_form,procurement_id',
        ...
        try {
            ...
            DB::connection('spark')->transaction(function () use ($validatedData, $unit, $status) {
                ...
                $record = DB::connection('spark')->table('procurement_form')
                    ->where('procurement_id', $validatedData['procurement_id'])
                    ->first();
