...
<body>
    ...
    <header class="d-flex align-items-center justify-content-between bg-black text-white p-3 shadow" id="stickyHeader">
        <div class="logo d-flex align-items-center">
            ...
            <img src="/assets/dtc-logo.png" alt="DTC Logo" class="img-fluid ms-2">
        </div>
    ...
    <div class="container-fluid mt-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><strong>Approved Budget (Purchase Request):</strong> <span id="modalApprovedBudget"></span></p>
                            <p><strong>Actual Amount (Purchase Order):</strong> <span id="modalPurchaseRequest"></span></p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="procurementForm">
                            ...
                            <div class="mb-3">
                                <label for="approved-budget" class="form-label">Approved Budget (Purchase Request)</label>
                                <input type="number" class="form-control" id="approved-budget" placeholder="Enter Approved Budget">
                            </div>
                            <div class="mb-3">
                                <label for="pr-amount" class="form-label">Actual Amount (Purchase Order)</label>
                                <input type="number" class="form-control" id="pr-amount" placeholder="Enter Actual Amount">
                            </div>
                            <div class="mb-3">
        ...
        <script src="/js/dtc/fetchSaro.js"></script>
        <script src="/js/dtc/fetchProcurement.js"></script>
        <script src="/js/dtc/searchProcurement.js"></script>
        <script src="/js/dtc/addProcurement.js"></script>
        <script src="/js/dtc/addSaro.js"></script>
        <script src="/js/dtc/filterSaroByYear.js"></script>
        <!-- <script src="/sarohover.js"></script> -->
        <script src="/js/dtc/overdueNotification.js"></script>
