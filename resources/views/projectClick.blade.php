...
<body>
    ...
    <div class="container-fluid mt-3">
        ...
        <script src="/js/click/fetchSaro.js"></script>
        <script src="/js/click/fetchProcurement.js"></script>
        <script src="/js/click/searchProcurement.js"></script>
        <script src="/js/click/addProcurement.js"></script>
        <script src="/js/click/addSaro.js"></script>
        <script src="/js/click/filterSaroByYear.js"></script>
        <!-- <script src="/sarohover.js"></script> -->
        <script src="/js/click/overdueNotification.js"></script>
