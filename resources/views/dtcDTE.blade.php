...
<body>
    ...
    <script src="/js/dtc/travelExpensesUploadCheck.js"></script>
    <script src="/js/dtc/otherexpenseformIndicator.js"></script>
    <script src="/js/dtc/requirementsUploadOtherExpense.js"></script>
</body>
