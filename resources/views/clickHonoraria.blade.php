...
<body>
    ...
    <script src="/js/click/honorariaUploadCheck.js"></script>
    <script src="/js/click/honorariaformIndicator.js"></script>
    <script src="/js/click/requirementsUpload.js"></script>
</body>
</html>