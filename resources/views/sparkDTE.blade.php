...
<body>
    ...
    <script src="/js/spark/travelExpensesUploadCheck.js"></script>
    <script src="/js/spark/otherexpenseformIndicator.js"></script>
    <script src="/js/spark/requirementsUploadOtherExpense.js"></script>
</body>
